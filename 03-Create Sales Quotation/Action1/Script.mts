 ...
 @@ script infofile_;_ZIP::ssf9.xml_;_
		wait(2)
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 2,2
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 2,3
		...
		'pressButton("TAB")
		wait(5)
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 2,5
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 2,6
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 2,8
		...
		wait(2)
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 3,2
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 3,3
		...
		'pressButton("TAB")
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 3,5
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 3,6
		...
		Browser("Home").Page("Home").SAPFrame("Create Quotation: Overview").SAPTable("All Items").ActivateCell 3,8
